...
RSpec.describe Category, type: :model do
  ...
  let(:admin2) {FactoryBot.create(:admin, project_id: 222222, email: '1@example.com')}
  ...
  context 'リレーションについて' do
    ...
    it '異なるproject_idを持つadminが同じタイトルのカテゴリーを作成できること' do
      category1 = FactoryBot.create(:category, admin: admin)
    ...
    it 'categoryを削除すると、関連するcontentも削除されること' do
      content = FactoryBot.create(:content, admin: admin, category: category)
